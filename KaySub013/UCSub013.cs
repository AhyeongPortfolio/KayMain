...
namespace KaySub013
{
    ...
    public partial class UserControl1: UserControl
    {
        ...
        public UserControl1()
        {
            ...
            ct_papr_date.KeyPress += Number_Only_Protect;
        ...
        public void BtnSearch_Click()
        {
            ...
            try
            {
                ...
                cmd.BindByName = true;
                cmd.Parameters.Add("papr_appno", OracleDbType.Varchar2).Value = "%" + papr_appnoSearch.Text + "%";
        ...
        public void BtnDelete_Click()
        {
            ...
            try
            {
                ...
                using (con = Utility.SetOracleConnection())
                {
                    OracleCommand cmd = con.CreateCommand();
                    cmd.BindByName = true;
                    cmd.CommandText = SQLStatement.CheckSQL;
                    ...
                    {
                        MessageBox.Show("발령이 진행된 자료는 삭제가 불가능합니다.", "삭제확인", MessageBoxButtons.OK, MessageBoxIcon.Warning);
                        return;
                    }
                }                
            }
        ...
        private void Input_Validation_Check(object sender, EventArgs e)
        {
            ...
            //*---------------------------------------------------------------------------------------------------------
            if (string.IsNullOrEmpty(ct_papr_num.Text))
            {
                SetError(ct_papr_num, "인원수를 반드시 입력하세요", dataGridView1.SelectedRows[0], errorProvider1);
            }
            else
            {
            ...
            //*---------------------------------------------------------------------------------------------------------
            if (string.IsNullOrEmpty(ct_papr_date.Text))
            {
