...
namespace KaySub018
{
    public partial class UserControl1 : UserControl
    {
        ...
        public UserControl1()
        {
            ...
            ct_evalm_year.KeyPress += Number_Only_Protect;
        ...
        public void BtnSave_Click()
        {
            ...
            try
            {
                ...
                foreach (DataGridViewRow row in dataGridView1.Rows)
                {
                    ...
                    cmd.Parameters.Add("EVALM_TEE", OracleDbType.Varchar2).Value = row.Cells["EVALM_TEE"].Value;
            ...
            {
                if (row.Cells["status"].Value.Equals("")) continue;
                row.Cells["Key1"].Value = row.Cells["EVALM_YEAR"].ToString();
                row.Cells["Key2"].Value = row.Cells["EVALM_NO"].ToString();
                row.Cells["Key3"].Value = row.Cells["EVALM_TEE"].ToString();
                row.Cells["Key4"].Value = row.Cells["EVALM_STAGE"].ToString();
                row.Cells["status"].Value = "";
            }
        ...
        private void Input_Validation_Check(object sender, EventArgs e)
        {
            ...
            //*---------------------------------------------------------------------------------------------------------
            if (string.IsNullOrEmpty(ct_evalm_tor.Text))
            {
