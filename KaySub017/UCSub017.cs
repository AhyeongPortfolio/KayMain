...
namespace KaySub017
{
    ...
    public partial class UserControl1 : UserControl
    {
        ...
        public void BtnSearch_Click()
        {
            ...
            try
            {
                ...
                while (dr.Read())
                {
                    ...
                    row.Cells["Key1"].Value = dr["EVAL_YEAR"].ToString();
                    row.Cells["Key2"].Value = dr["EVAL_NO"].ToString();
        ...
        public void BtnSave_Click()
        {
            ...
            {
                if (row.Cells["status"].Value.Equals("")) continue;
                row.Cells["Key1"].Value = row.Cells["EVAL_YEAR"].ToString();
                row.Cells["Key2"].Value = row.Cells["EVAL_NO"].ToString();
                row.Cells["status"].Value = "";
            }
