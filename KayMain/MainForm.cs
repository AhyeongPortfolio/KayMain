...
namespace KayMain
{
    ...
    public partial class MainForm : Form
    {
        ...
        private string subdir = @"\"; //dll 파일 관리용도
        private string FTP = "10.100.10.1"; // 버전 .dll 을 서버에 저장 //외부화 필요: 유지보수를 위함
        Button[] button;
        ...
        {
            InitializeComponent();
            tv_MainMenu.DoubleClick += tv_MainMenu_DoubleClick;
            tabControl.MouseClick += tabControl_MouseClick;
            tabControl.DrawItem += tabControl_DrawItem;
            tabControl.Selected += tabControl_Selected;
        }

        #region (EVENT)메인 프로그램 시작시
        //****************************************************************
        //-- 메인프로그램 시작 이벤트
        //****************************************************************
