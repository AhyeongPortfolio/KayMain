...
namespace KaySub022
{
    ...
    /// **********************************************************************
    /// </summary>
    class KaySub022Empolyee
    {
        public KaySub022Empolyee() { }
        public KaySub022Empolyee(string name, string empno, string resno, string addr, string sts, string pos, string dept,
