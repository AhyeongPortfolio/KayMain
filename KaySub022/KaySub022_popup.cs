...
namespace KaySub022
{
    ...
    public partial class KaySub022_popup : Form
    {
        ...
        private void Car_Data_GetSet() // 경력
        {
            ...
            ReportDataSource rds = new ReportDataSource("DataSet2", careerList);
            this.reportViewer1.LocalReport.DataSources.Add(rds);

        }

        private void Ceri_Data_GetSet() // 재직
        {
            try
            {
                DataTable dt;
            ...
            ReportDataSource rds = new ReportDataSource("DataSet1", empolyeeList);
            this.reportViewer1.LocalReport.DataSources.Add(rds);
        }
        #endregion
        #endregion
